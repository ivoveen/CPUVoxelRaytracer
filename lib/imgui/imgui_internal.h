...
public:
    ...
    float       CalcFontSize() const    { ImGuiContext& g = *GImGui; float mScale = g.FontBaseSize * FontWindowScale; if (ParentWindow) mScale *= ParentWindow->FontWindowScale; return mScale; }
...
//#endif
    ...
    IMGUI_API void          RenderMouseCursor(ImVec2 pos, float mScale, ImGuiMouseCursor mouse_cursor, ImU32 col_fill, ImU32 col_border, ImU32 col_shadow);

    // Render helpers (those functions don't access any ImGui state!)
    IMGUI_API void          RenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float mScale = 1.0f);
