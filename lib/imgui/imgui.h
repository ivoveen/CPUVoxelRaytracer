...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowFontScale(float mScale);                                            // [OBSOLETE] set font scale. Adjust IO.FontGlobalScale if you want to scale all windows. This is an old API! For correct scaling, prefer to reload font + rebuild ImFontAtlas + call style.ScaleAllSizes().
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddCircle(const ImVec2& center, float mRadius, ImU32 col, int num_segments = 0, float thickness = 1.0f);
    IMGUI_API void  AddCircleFilled(const ImVec2& center, float mRadius, ImU32 col, int num_segments = 0);
    IMGUI_API void  AddNgon(const ImVec2& center, float mRadius, ImU32 col, int num_segments, float thickness = 1.0f);
    IMGUI_API void  AddNgonFilled(const ImVec2& center, float mRadius, ImU32 col, int num_segments);
    ...
    IMGUI_API void  PathArcTo(const ImVec2& center, float mRadius, float a_min, float a_max, int num_segments = 0);
    IMGUI_API void  PathArcToFast(const ImVec2& center, float mRadius, int a_min_of_12, int a_max_of_12);                // Use precomputed angles for a 12 steps circle
    ...
    IMGUI_API int   _CalcCircleAutoSegmentCount(float mRadius) const;
    IMGUI_API void  _PathArcToFastEx(const ImVec2& center, float mRadius, int a_min_sample, int a_max_sample, int a_step);
    IMGUI_API void  _PathArcToN(const ImVec2& center, float mRadius, float a_min, float a_max, int num_segments);
};
...
struct ImFont
{
    ...
    IMGUI_API const char*       CalcWordWrapPositionA(float mScale, const char* text, const char* text_end, float wrap_width) const;
